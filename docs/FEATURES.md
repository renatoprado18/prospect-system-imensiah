...
- **Endpoints**: `GET /api/projects/{id}/raci` (`?status=` filtra os itens; o **resumo continua do conjunto completo**) · `POST /api/projects/{id}/raci` · `PATCH|DELETE /api/raci-itens/{id}`
...
- Testes: `tests/test_raci_matrix.py` (18)
